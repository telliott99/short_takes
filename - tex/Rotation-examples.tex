...
We have
\[ B^2(c^4 + s^4) - 2B^2c^2s^2 + 4B^2c^2s^2 \]
\[ = B^2(c^4 + s^4 + 2c^2s^2) \]
\[ = B^2(c^2 + s^2)^2 = B^2 \]
...
This is only a parabola if either $A$ or $C$ is zero.  So then $B^2 - 4AC$ must be zero no matter where the parabola was placed or how it was rotated.
