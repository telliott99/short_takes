...
Suppose that $x^2 < N$.  Then 
\[ 1/x^2 > 1/N \]
\[ N^2/x^2 > N \]
\[ g^2 > N > x^2 \] 
[The  converse is true also].

Furthermore, $g$ is closer to $\sqrt{N}$ than $x$ is, it's a better guess.
...
The source calls this the "Babylonian method", but I've always known it as the Newton-Raphson method.  It's a linear approximation.  
