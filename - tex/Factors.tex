...
Numbers that are not prime, called composite, do have other factors.  There is only one extra, if the number is a perfect square of a prime.  Examples:
\[ 9 = 3 \cdot 3, \ \ \ \ \ \ 25 = 5 \cdot 5, \ \ \ \ \ \  49 = 7 \cdot 7 \ \ \dots \]

Usually, there are at least two factors.  Here are factorizations of composite numbers up to $25$:
