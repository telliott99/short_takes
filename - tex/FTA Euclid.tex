...
The proof depends on B\'ezout's identity (or lemma), which we look at elsewhere.  B\'ezout says that there for $a,p \in \mathbb{N}$, there exist integers $r$ and $s$ such that
\[ ra + sp = d \]
