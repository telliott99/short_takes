...
For the integers between $2$ and $10$, finding decimal equivalents for the reciprocals, fractions like $1/2$ and $1/5$ and so on, are pretty simple ($0.5$ and $0.2$, respectively).
