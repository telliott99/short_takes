...
Consider $p_1$, the least factor in the factorization of $n$, $p_1 p_2 \dots p_k$.  
...
The other possibility is that $p_1 \cdot p_1 < n$  The above inequality still holds.  In all cases, $p_1 \cdot q_1 < n$.
